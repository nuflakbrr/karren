...
export default function Navbar() {
    ...
    const activeClass = 'text-white bg-green-700'
    const inactiveClass = 'text-gray-500 hover:text-white hover:bg-green-600 transition duration-300 ease-in-out'
                        ...
                        <NavLink to='/'>
                            <div className='ml-3 relative'>
                                <div className='flex items-center'>
                                    ...
                                    />
                                    <h3 className='ml-2 font-bold md:text-xl text-lg'>KARREN</h3>
                                </div>
                            </div>
                        </NavLink>
                    </div>
