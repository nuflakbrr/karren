                    ...
                    <div class="bg-white py-6 sm:py-8 lg:py-12">
                        <div class="max-w-screen-lg px-4 md:px-8 mx-auto">
                            ...
                            <div class="flex flex-wrap justify-center items-center gap-4 sm:gap-0">
                                ...
                                {/* <!-- right side - start --> */}
                                <div class="w-full sm:w-1/2 bg-gradient-to-tr from-teal-700 to-green-600 rounded-lg shadow-xl p-6 sm:p-8">
                                    <div class="flex flex-col lg:flex-row justify-between items-start gap-4 mb-4">
                                        ...
                                        <span class="inline-block order-first lg:order-none bg-indigo-200 bg-opacity-50 text-white text-xs font-semibold tracking-wider uppercase rounded-full px-3 py-1">rekomendasi</span>
                                    </div>
