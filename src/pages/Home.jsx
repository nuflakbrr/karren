                    ...
                    <section className="my-10">
                        <div className="py-6 sm:py-8 lg:py-12">
                            <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                                ...
                                <div className="text-center grid sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-8">
                                    {/* <!-- feature - start --> */}
                                    <div className="flex flex-col border rounded-lg p-4 md:p-6">
                                        <span className="text-white bg-green-700 p-3 rounded-full w-fit self-center">
                                            <svg
                                                width={43}
                                                height={43}
                                                viewBox="0 0 24 24"
                                            ...
                                            >
                                                <circle cx="12" cy="7" r="5" stroke="white" strokeWidth="2" />
                                                <path d="M17 14H17.3517C18.8646 14 20.1408 15.1266 20.3285 16.6279L20.719 19.7519C20.8682 20.9456 19.9374 22 18.7344 22H5.26556C4.06257 22 3.1318 20.9456 3.28101 19.7519L3.67151 16.6279C3.85917 15.1266 5.13538 14 6.64835 14H7" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </span>
                                        ...
                                        <p className="text-gray-500 mb-4">
                                            Supir yang kami berikan kepada Anda telah berpengalaman.
                                        </p>
                                    </div>
                                    {/* <!-- feature - end --> */}
                                    ...
                                    <div className="flex flex-col border rounded-lg p-4 md:p-6">
                                        <span className="text-white bg-green-700 p-3 rounded-full w-fit self-center">
                                            ...
                                            >
                                                <path d="M388.223,160.284h-22.944l-30-136.252H52.943l-30,136.252H0v139.15h20v64.756h100v-64.756h148.223v64.756h100v-64.756h20 V160.284z M30,269.435v-79.15h328.223v79.15H30z M77.057,54.032h234.109l23.395,106.252H53.662L77.057,54.032z M90,334.19H50 v-34.756h40V334.19z M338.223,334.19h-40v-34.756h40V334.19z" />
                                        ...
                                        <p className="text-gray-500 mb-4">
                                            Perawatan rutin selalu kami laukan, yaitu perawatan mobil mingguan, bulanan.
                                        </p>
                                    </div>
                                    {/* <!-- feature - end --> */}
                                    ...
                                    <div className="flex flex-col border rounded-lg p-4 md:p-6">
                                        ...
                                        <p className="text-gray-500 mb-4">
                                            Kami jamin tarif yang kami tawarkan sangat terjangkau dan kompetitif.
                                        </p>
                                    </div>
                                    {/* <!-- feature - end --> */}
                                    ...
                                    <div className="flex flex-col border rounded-lg p-4 md:p-6">
                                        ...
                                        <p className="text-gray-500 mb-4">
                                            Proses rental dan sewa mobil cukup mudah, cukup pesan melalui website kami maka kami akan segera proses pesanan Anda.
                                        </p>
                                    </div>
                                    {/* <!-- feature - end --> */}
                                </div>
                    ...
                    <section>
                        <div className="bg-white py-6 sm:py-8 lg:py-12">
                            <div className="max-w-screen-lg px-4 md:px-8 mx-auto">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 bg-green-700 rounded-lg gap-6 md:gap-8 p-6 md:p-8">
                                    {/* <!-- stat - start --> */}
                                    <div className="flex flex-col items-center">
                                        <div className="text-white text-xl sm:text-2xl md:text-3xl font-bold">200</div>
                                        <div className="text-green-200 text-sm sm:text-base">People</div>
                                    </div>
                                    {/* <!-- stat - end --> */}
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="text-green-200 text-sm sm:text-base">Customers</div>
                                    </div>
                                    {/* <!-- stat - end --> */}
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="text-green-200 text-sm sm:text-base">Coffee breaks</div>
                                    </div>
                                    {/* <!-- stat - end --> */}
                                </div>
                            </div>
                        ...
                        <div className="max-w-screen-lg px-4 md:px-8 mx-auto">
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-0">
                                ...
                                <div className="w-full sm:w-1/2 lg:w-1/3 bg-gray-800 rounded-lg sm:rounded-r-none p-6 sm:p-8">
                                    ...
                                    <a href="#" className="block bg-gray-500 hover:bg-gray-600 focus-visible:ring ring-indigo-300 text-gray-100 active:text-gray-300 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Get the Basic Bundle</a>
                                </div>
                                {/* <!-- left side - end --> */}

                                {/* <!-- right side - start --> */}
                                <div className="w-full sm:w-1/2 bg-gradient-to-tr from-teal-700 to-green-600 rounded-lg shadow-xl p-6 sm:p-8">
                                    <div className="flex flex-col lg:flex-row justify-between items-start gap-4 mb-4">
                                        ...
                                        <span className="inline-block order-first lg:order-none bg-indigo-200 bg-opacity-50 text-white text-xs font-semibold tracking-wider uppercase rounded-full px-3 py-1">rekomendasi</span>
                                    </div>
                                    ...
                                    <a href="#" className="block bg-indigo-200 bg-opacity-50 hover:bg-indigo-300 active:bg-indigo-400 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Get the Pro Bundle</a>
                                </div>
                                {/* <!-- right side - end --> */}
                            </div>
                        </div>
                        ...
                        <div className="bg-white py-6 sm:py-8 lg:py-12">
                            <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                                <div className="md:h-80 flex flex-col sm:flex-row bg-gray-200 rounded-lg overflow-hidden">
                                    {/* <!-- image - start --> */}
                                    <div className="w-full sm:w-1/2 lg:w-2/5 h-48 sm:h-auto order-first sm:order-none bg-slate-300">
                                        <img src={CarHome} loading="lazy" alt="Photo by Andras Vas" className="w-full h-full object-cover object-center" />
                                    </div>
                                    {/* <!-- image - end --> */}
